const tokens = {
  ...
  "colors.grayScale.dark": {
    "value": "#212121",
    "variable": "var(--colors-gray-scale-dark)"
  },
  "colors.grayScale.medium": {
    "value": "#666666",
    "variable": "var(--colors-gray-scale-medium)"
  },
  "colors.grayScale.light": {
    "value": "#E0E0E0",
    "variable": "var(--colors-gray-scale-light)"
  },
  "colors.grayScale.background": {
    "value": "#EFEFEF",
    "variable": "var(--colors-gray-scale-background)"
  },
  "colors.grayScale.white": {
    "value": "#FFFFFF",
    "variable": "var(--colors-gray-scale-white)"
  },
  "breakpoints.sm": {
    "value": "640px",
